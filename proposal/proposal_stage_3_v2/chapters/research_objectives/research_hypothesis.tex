...
\begin{itemize}
    ...
    Holding the compositional method fixed, models with more clearly separated concept
    representations should exhibit a smaller composability gap than models with more entangled
    ones.

    \item \textbf{H3 (The Clinical Independence Sufficiency Hypothesis):}
    Approximate clinical independence between chest X-ray pathologies is sufficient for logical composition to generate plausible co-morbid outputs, including out-of-distribution pairings unseen during training, provided the model has learned sufficiently distinct pathology-specific representations.
